...
public class PizzaApp {
	...
	public String arrayListDemo() {
		...
		if(iCount < 5) {
			...
			listLen = "The menu list is medum length";
		}
		
		int i2=5;
		
		do {
			System.out.println("Enjoy drinks: " + drinks[i2]);
			i2--;
		}while(i2>1);
	...
	public static void main(String[] args) {
		...
		System.out.println("small pizza: " + myPizza.myAddit(" total price with one topping", 10, .06));
		System.out.println("medium pizza: " + myPizza.myAddit(" total price with one topping" , 14, .06));
		System.out.println("Large pizza: " + myPizza.myAddit(" total price with one topping" , 16, .06));
		System.out.println("X-Large pizza: " + myPizza.myAddit(" total price with one topping" , 18, .06));
	    ...
	    System.out.println("10 inch calzone: " + myCalzones.myAddit("total price:", 10.50, 0.06));
